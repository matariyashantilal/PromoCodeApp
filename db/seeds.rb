...
s=Store.create(name:"store1",address:"Sola Road,Bhyugdev",contact_person:"store1",contact_number:"1234567890",business_id:b.id)

s1=Store.create(name:"store2",address:"Gurukul,Memnager",contact_person:"store2",contact_number:"1234567891",business_id:b.id)

s3=Store.create(name:"store3",address:"sarvopali mall Bhyugdev",contact_person:"store3",contact_number:"1234567895",business_id:b.id)
